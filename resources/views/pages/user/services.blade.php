...
<body>
    ...
    <!-- Header Banner -->
    <section class="banner-header section-padding bg-img" data-overlay-dark="6" data-background="images/slider/11.jpg">
        <div class="v-middle">
            <div class="container">
                <div class="row">
    ...
    <!-- Booking Search -->
    <section class="background bg-img bg-fixed section-padding" data-overlay-dark="5" data-background="images/slider/2.jpg">
        <div class="container">
            <div class="row">
